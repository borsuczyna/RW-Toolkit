    ...
    peek<T extends number | string | Buffer>(dataType: DataType, additionLength?: number): T {
        ...
        switch (dataType) {
            case DataType.UInt32:
                ...
                } else if(this.buffer) result = this.buffer.readUInt32BE(this.position);
            ...
            case DataType.UInt24:
                if(this.file) {
                    const buffer = Buffer.alloc(readLength);
                    fs.readSync(this.fd!, buffer, 0, readLength, this.position);
                    result = buffer.readUIntBE(0, readLength);
                } else if(this.buffer) result = this.buffer.readUIntBE(this.position, readLength);
            ...
            case DataType.UInt16:
                ...
                } else if(this.buffer) result = this.buffer.readUInt16BE(this.position);
            ...
            case DataType.Int32:
                ...
                } else if(this.buffer) result = this.buffer.readInt32BE(this.position);
            ...
            case DataType.Int24:
                if(this.file) {
                    const buffer = Buffer.alloc(readLength);
                    fs.readSync(this.fd!, buffer, 0, readLength, this.position);
                    result = buffer.readIntBE(0, readLength);
                } else if(this.buffer) result = this.buffer.readIntBE(this.position, readLength);
            ...
            case DataType.Int16:
                ...
                } else if(this.buffer) result = this.buffer.readInt16BE(this.position);
            ...
            case DataType.Float:
                ...
                } else if(this.buffer) result = this.buffer.readFloatBE(this.position);
    ...
    write<T extends number | string | Buffer>(data: T, dataType: DataType, additionLength?: number) {
        ...
        switch (dataType) {
            case DataType.UInt32:
                ...
                buffer.writeUInt32BE(<number>data, 0);
                break;
            case DataType.UInt24:
                buffer = Buffer.alloc(writeLength);
                buffer.writeUIntBE(<number>data, 0, writeLength);
                break;
            case DataType.UInt16:
                buffer = Buffer.alloc(writeLength);
                buffer.writeUInt16BE(<number>data, 0);
                break;
            case DataType.UInt8:
                buffer = Buffer.alloc(writeLength);
            ...
            case DataType.Int32:
                buffer = Buffer.alloc(writeLength);
                buffer.writeInt32BE(<number>data, 0);
                break;
            case DataType.Int24:
                buffer = Buffer.alloc(writeLength);
                buffer.writeIntBE(<number>data, 0, writeLength);
                break;
            case DataType.Int16:
                buffer = Buffer.alloc(writeLength);
                buffer.writeInt16BE(<number>data, 0);
                break;
            case DataType.Int8:
                buffer = Buffer.alloc(writeLength);
            ...
            case DataType.Float:
                buffer = Buffer.alloc(writeLength);
                buffer.writeFloatBE(<number>data, 0);
                break;
            case DataType.Char:
